"""
Django settings for patient_art_42290 project.
...
ROOT_URLCONF = 'patient_art_42290.urls'
...
WSGI_APPLICATION = 'patient_art_42290.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_art_42290 API",
    "DESCRIPTION": "API documentation for patient_art_42290 App",
    "VERSION": "v1",
}
